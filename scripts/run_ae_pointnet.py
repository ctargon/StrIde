...
from models.vae_pointnet import PointNet_VAE
...
if __name__ == '__main__':
	...
	parser.add_argument('--model', help='ae/vae vanilla autoencoder or variational autoencoder', type=str, required=True, choices=['ae', 'vae'])
